...
<div id="group_chat_dialog" title="Group Chat Window">
    <div id="group_chat_history" style="height:400px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:24px; padding:16px;background-color: #121212;color: #A3A3A3;"></div>
...
$(document).ready(function(){
 ...
 function make_chat_dialog_box(to_user_id, to_user_name){
  ...
  modal_content += '<div style="height:400px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:24px; padding:16px; background-color: #121212;color: #A3A3A3;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
