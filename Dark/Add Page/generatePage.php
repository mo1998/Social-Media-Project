...
<script>
        ...
        function change(){
                var url = "../../Light/Add Page/generatePage.php";
                window.location = url;
            }
        function Un_Join(){
...
<html>
    ...
    <div Class="Orange1">
        ...
        <div class="change" style="overflow-y:auto;position: absolute;top: 50px;left: 260px;">
            <div style="top: 10px;left: 15px; background-color: #2d2d2d;width:800px;height:245px;border-radius:30px;position: relative;">
                    ...
                    <a style="position:absolute;top: 30px;left: 250px;padding: 5px;font-size: 30px;font-weight: bold;color: #a3a3a3;text-decoration: none;" href="../Group/LightGroup.php"><?php  echo $_SESSION['pagename']; ?></a><!--no word exceed 16 letters and no page name exceeds two lines -->
                    <br><br>
                    <div style="position: absolute;left: 255px;top: 95px;width:150px;">
                        <div class="type" style="color:#a3a3a3"><img src="../Icons/type.png"width="18"height="18" title="Group Type"> <?php echo $_SESSION['pagetype']; ?></div><br>
                        <div class="admin" style="color:#a3a3a3"><img src="../Icons/admin.png"width="18"height="18" title="Admin Name" style="display:Inline;"> <?php echo $_SESSION['pageadmin']; ?></div>
                    </div>
                    <button style="height: 60px;width: 60px;right: 40px;bottom: 25px;background-color: #2d2d2d;cursor:pointer;border-style: none;position: absolute;" onclick="fn1()">
        ...
        <div id="posts">
                <?php foreach($result as $one){ ?>
                    <section class="post" style="overflow:hidden;padding: 20px;font-size: 30px;align-items: center;justify-content: center;top: 350px;left:270px;grid-area: name;position: relative;background-color: #2d2d2d;margin: 10px;border: 1px solid #2d2d2d;border-radius: 30px;width: 760px;height: 350px;font-size: 30px;align-items: center;position: relative;">
                        ...
                        <div class="head" style = "color: #a3a3a3;position: absolute;left: 130px;top: 40px;font-size: 30px;"><?php echo $_SESSION['pagename']; ?></div>
                        <p class="info" style="grid-area: content;padding:15px;margin-bottom:25px;margin-top: 35px;margin-left: 50px;margin-right: 10px;color:#a3a3a3;font-size: 25px;"><?php echo $one['post_caption']; ?></p>
                        <button  onclick="fn3()" class="pes" style = "grid-area: like;border-top:4px solid  #d8d7d6;padding: 5px;height: 116px;border-radius: 0px 0px 0px 30px;background-color: #2d2d2d;border-right: #2d2d2d;border-bottom: #2d2d2d;border-left: #2d2d2d;position: absolute;bottom: 0px;left: 0px;width: 100px;">
                            
                            <?php if($one['pecset'] == 1){ ?>
                                <img id="Pes" src="../Icons/Pes Pressed.png" alt="" style="position: absolute;left: 10px;bottom: 0px;height: 70px;width: 50px;background-color: #2d2d2d;">
                            <?php }else{?>
                                <img id="Pes" src="../Icons/Pes Unpressed.png" alt="" style="position: absolute;left: 10px;bottom: 0px;height: 70px;width: 50px;background-color: #2d2d2d;">
                            <?php }?>
                        </button>
                        <button class="share" style="border-top: 4px solid  #d8d7d6;grid-area: share;padding: 5px;height: 116px;border-radius: 0px 0px 30px 0px;background-color: #2d2d2d;border-right: #2d2d2d;border-bottom: #2d2d2d;border-left: #2d2d2d;position: absolute;bottom: 0px;left: 0px;width: 100px;"><img src="../Icons/Share.png" alt=""></button>
                        ...
                        <div id="Dropdown" class="drop-content" style="top: 30px;right: 55px;display: none;position: absolute;background-color: #2d2d2d;min-width: 160px;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 1;">
                            <a href="../Add Post/AddPost.html">Edit Post</a>
                            <a href="#">Save Post</a>
                        </div>
                        <form method="POST" class="Frm" style = "grid-area:comment;border-top: 4px solid  #d8d7d6">
                            <input type="text" id="comment" name="comment" placeholder="Discuss Here ..." style="font-size: 16px;background-color: #2d2d2d;color: #d8d7d6;width: 100%;padding: 20px 20px;margin: 20px 0;box-sizing: border-box;font-size:30px;border-color: #d8d7d6;border-radius:0 0 30px 30px;">
